...
Partial Class DataParking
    ...
    Public Shared IdDataP, latitud, longitud As String

    Private Sub DataParking_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            IdDataP = Request.QueryString.Item("par_id")
            ...
            datasetparkingspots = ps.GetValues(IdDataP)
    ...
    Protected Sub CoordinatesBtn_Click(sender As Object, e As EventArgs) Handles CoordinatesBtn.Click
        Response.Redirect("Home.aspx?par_id=" & IdDataP + "&par_lat=" & latitud + "&par_long=" & longitud)
    End Sub
End Class
